      ...
      >
        ...
        >
          ...
          <button
            onClick={handleRetry}
            disabled={isChecking}
            className="w-full mt-2 py-3.5 px-4 rounded-[18px] bg-[#FF8A1F] text-[#100E0B] font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-md active:scale-[0.97] transition-all border border-[#FF8A1F] disabled:opacity-60"
          >
