...
const COPY = {
  it: {
    title: "Fotografa il problema",
    close: "Chiudi",
    hint: "Inquadra il guasto, il pezzo rotto o il punto dove devi lavorare",
    shoot: "Scatta",
    retake: "Rifai",
  ...
  en: {
    ...
    close: "Close",
    hint: "Point at the fault, the broken part, or where you need to work",
    shoot: "Shoot",
    retake: "Retake",
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[9991] mx-auto flex max-w-lg select-none flex-col items-center gap-4 rounded-t-[32px] border-t border-[#332A1E] bg-[#1A1611]/95 p-6 pb-[max(24px,env(safe-area-inset-bottom,0px))] font-sans shadow-[0_-12px_40px_rgba(0,0,0,0.4)] backdrop-blur-lg gpu-layer"
          >
            ...
            {/* Mirino / anteprima */}
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[22px] border border-[#332A1E] bg-[#100E0B]">
              {photo ? (
                ...
                <>
                  ...
                  {!streamReady && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Camera className="h-9 w-9 text-[#3A3226]" strokeWidth={1.6} />
                    </div>
                  )}
            ...
            <p className="text-center text-xs font-semibold text-[#A89880]">{t.hint}</p>
            ...
            <div className="flex w-full items-center justify-center gap-3">
              {photo ? (
                ...
                <button
                  ...
                  aria-label={t.shoot}
                  className="flex h-16 w-16 cursor-pointer items-center justify-center rounded-full bg-[#FF8A1F] text-[#100E0B] shadow-[0_0_28px_rgba(255,138,31,0.45)] transition-transform active:scale-95 disabled:opacity-40"
                >
