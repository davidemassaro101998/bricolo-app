              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 w-full shrink-0 pt-0.5">
                  ...
                  <a
                    ...
                    className="surface-coral-tactile py-2.5 sm:py-3 px-2 rounded-[16px] active:scale-[0.98] hover:brightness-105 text-[#100E0B] font-black text-[11px] sm:text-xs flex items-center justify-center gap-1.5 cursor-pointer shadow-sm transition-transform uppercase tracking-wider border-2 border-transparent"
                  >
