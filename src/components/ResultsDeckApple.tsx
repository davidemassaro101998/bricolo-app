...
export const ResultsDeckApple: React.FC<ResultsDeckAppleProps> = React.memo(({
  ...
  // WhatsApp Share Text
  const wsText = t.whatsAppShareText
    .replace("{title}", currentGift?.title || "")
    .replace("{price}", currentGift?.price || "")
    .replace("{url}", buildAmazonUrl(currentGift?.amazonSearchQuery || "", country, currentGift));
      ...
      <div className="flex items-center justify-between shrink-0 pt-0.5 pb-2 border-b border-[#E5E5EA]">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <span className="text-[12px] font-extrabold text-[#E8590C] uppercase tracking-wider flex items-center gap-1">
        ...
        <button
          onClick={onStartOver}
          className="py-1 px-2.5 sm:py-1.5 sm:px-3 rounded-full bg-white border border-[#E5E5EA] text-[#E8590C] hover:bg-[#E5E5EA] active:scale-95 transition-transform text-[14px] font-bold shadow-2xs cursor-pointer shrink-0 ml-1 gpu-layer"
        >
          {t.newSearch}
        </button>
      </div>
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                <div className="flex items-center justify-between shrink-0">
                  ...
                  {currentGift.isPrime && (
                    <span className="text-[13px] font-semibold text-[#E8590C] bg-[#E8590C]/10 px-2 py-0.5 rounded-full tracking-tight">
                      ✓ Prime
                    </span>
                  )}
                </div>
                ...
                <div className="relative w-full h-[125px] sm:h-[145px] rounded-[16px] sm:rounded-[20px] overflow-hidden bg-[#FAFAFC] border border-[#E5E5EA] flex items-center justify-center p-2 shrink-0">
                  ...
                  {imgStatus === "error" && (
                    <div
                      ...
                      style={{ background: "linear-gradient(145deg, #FFE8D6, #F2F2F7)" }}
                    >
                ...
                <div className="grid grid-cols-2 gap-2 w-full shrink-0 pt-0.5">
                  <a
                    ...
                    className="min-w-0 py-2.5 sm:py-3 px-2 rounded-[16px] bg-white border-2 border-[#E8590C] hover:bg-[#F2F2F7] active:scale-[0.98] text-[#E8590C] font-black text-[13px] flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs transition-all uppercase tracking-wider gpu-layer"
                  >
      ...
      <div className="shrink-0 pt-1.5 border-t border-[#E5E5EA] space-y-1">
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="py-2 sm:py-2.5 px-2 rounded-2xl bg-white border border-[#E5E5EA] hover:border-[#E8590C] text-[#000000] font-bold text-[14px] flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-2xs active:scale-[0.98] gpu-layer"
          >
            <MessageCircle className="w-4 h-4 text-[#E8590C] shrink-0" />
            <span className="truncate">
              {copiedWs ? t.copyLinkDone : t.copyLink}
            </span>
