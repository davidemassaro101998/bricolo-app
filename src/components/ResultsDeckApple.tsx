      ...
      <div className="shrink-0 pt-1.5 border-t border-[#EBE6DC] space-y-1">
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="py-2.5 sm:py-3 px-2 rounded-2xl bg-white border border-[#EBE6DC] hover:border-[#E8590C] text-[#000000] font-bold text-xs flex items-center justify-center gap-1.5 transition-transform cursor-pointer shadow-2xs active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="py-2.5 sm:py-3 px-2 rounded-2xl bg-white hover:bg-[#FFF3EA] text-[#000000] font-bold text-xs flex items-center justify-center gap-1.5 transition-transform cursor-pointer active:scale-[0.98] border-2"
