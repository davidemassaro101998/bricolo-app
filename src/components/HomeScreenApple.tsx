      ...
      <div className="shrink-0 pt-0.5">
        ...
        >
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            <Search className="w-4 h-4 text-[#68686D] group-hover:text-[#E8590C] transition-colors shrink-0" />
            ...
            >
              ...
              <div className="flex flex-col items-center gap-1.5 pb-1 pt-2">
                ...
                >
                  ...
                  />
                  <span
                    className="absolute inset-0 rounded-full shadow-[0_10px_28px_rgba(232,89,12,0.35)] raised-surface"
                    style={{ backgroundColor: "var(--brand-coral)" }}
                  />
            ...
            >
                ...
                <div className="relative flex items-center">
                  <span
                    className={`absolute left-3.5 text-sm font-bold transition-colors ${
                      isCustomBudgetFocused || customBudgetInput ? "text-[#E8590C]" : "text-[#68686D]"
                    }`}
                  >
                    €
                  </span>
              ...
              <div className="p-[clamp(6px,1.6vh,14px)] rounded-[22px] bg-white border border-[#E5E5EA] shadow-[0_8px_24px_rgba(0,0,0,0.04)] space-y-[clamp(2px,0.8vh,8px)]">
                ...
                <input
                  ...
                  placeholder={
                    t.extraDetailsPlaceholder
                  }
                  className="w-full py-2 px-3 rounded-xl bg-[#F2F2F7] border border-[#E5E5EA] text-[#000000] placeholder-[#68686D] text-xs sm:text-sm font-normal focus:outline-none focus:border-[#E8590C]"
                />
              </div>
            </motion.div>
          )}
      ...
      {wizardStep === 3 && (
        <div className="shrink-0 pb-[clamp(6px,1.4vh,12px)] pt-[clamp(4px,1vh,8px)] w-full space-y-[clamp(4px,1vh,10px)]">
          ...
          <button
            ...
            className="w-full py-4 rounded-[22px] bg-[#E8590C] hover:bg-[#C24A08] active:scale-[0.97] text-white font-bold text-sm sm:text-base flex items-center justify-center gap-2 cursor-pointer shadow-[0_8px_24px_rgba(232,89,12,0.3)] raised-surface transition-all uppercase tracking-wide border border-[#E8590C]"
          >
