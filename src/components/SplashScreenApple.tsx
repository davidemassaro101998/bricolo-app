...
export const SplashScreenApple: React.FC<SplashScreenAppleProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    // Show mini spinner ~0.2s after the Bricolo logo has fully taken over
    // (DGM exit ~250ms + Bricolo's own 800ms entrance ≈ 1600ms).
  ...
  return (
    ...
    >
      ...
      {/* mode="wait": guarantees the DGM mark's exit animation fully
          finishes before the Bricolo logo starts mounting/entering — never
      ...
      <div className="flex-1 flex flex-col items-center justify-end pb-10">
        ...
        {showSpinner && (
          ...
          >
            ...
            <div className="w-7 h-7 rounded-full border-[2.5px] border-[#E5E5EA] border-t-[#E8590C] border-r-[#E8590C]/60 animate-spin" />
