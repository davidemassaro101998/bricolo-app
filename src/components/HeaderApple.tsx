        ...
        <div className="w-full max-w-lg sm:max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1C1520] hover:bg-[#241A28] active:scale-95 border border-[#2B2130] text-[#F5F1EA] text-xs font-semibold shadow-2xs transition-transform cursor-pointer h-[34px]"
            >
            ...
            {onOpenSettings && (
              <button
                ...
                aria-label="Settings"
                className="flex items-center justify-center w-[34px] h-[34px] rounded-full bg-[#1C1520] hover:bg-[#241A28] active:scale-95 border border-[#2B2130] text-[#F5F1EA] shadow-2xs transition-transform cursor-pointer"
              >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`py-2 px-3 rounded-xl border text-xs font-bold flex items-center justify-center gap-2 cursor-pointer transition-all ${
                      language === "en"
                        ? "bg-[#FF8A1F] text-white border-[#FF8A1F] shadow-xs"
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-medium transition-all cursor-pointer ${
                          isSelected
                            ? "bg-[#FF8A1F] text-white font-bold shadow-xs"
