        ...
        <div className="w-full max-w-lg sm:max-w-2xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <span className="font-extrabold text-base sm:text-lg tracking-tight text-[#000000]">
              Bricolo <span className="text-[#E8590C] font-black">AI</span>
            </span>
          </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-fade-in">
          <div className="w-full max-w-sm rounded-[24px] bg-white border border-[#E5E5EA] p-5 shadow-2xl relative max-h-[85vh] flex flex-col my-auto text-[#000000]">
            <div className="flex items-center justify-between mb-3 shrink-0">
              <div className="flex items-center gap-2">
                <div className="p-2 rounded-xl bg-[#E8590C] text-white shadow-xs">
              ...
              <div className="p-3 rounded-2xl bg-[#F2F2F7] border border-[#E5E5EA] space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(["it", "en", "es", "fr", "de"] as Language[]).map((lang) => (
                    ...
                    >
                      <FlagIcon code={lang === "en" ? "GB" : lang} className="w-4 h-3" />
                  ...
                  {COUNTRIES.map((c) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          onSelectCountry(c);
                          // Suggerisce la lingua coerente con lo store scelto,
                          // ma solo per i mercati con una lingua locale ovvia
                          // (evita di forzarla per US/UK/CA/JP dove l'utente
                          // potrebbe legittimamente preferire un'altra lingua).
                          const suggestedLang: Language | undefined =
                            c.code === "IT" ? "it" : c.code === "ES" ? "es" : c.code === "FR" ? "fr" : c.code === "DE" ? "de" : undefined;
                          if (suggestedLang && language !== suggestedLang) {
                            onSelectLanguage(suggestedLang);
                          }
                        ...
                        className={`w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-medium transition-all cursor-pointer ${
                          isSelected
                            ? "bg-[#E8590C] text-white font-bold shadow-xs"
