                ...
                <div className="p-3.5 rounded-[22px] bg-[#F2F2F7] border border-[#E5E5EA] flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`w-11 h-6 rounded-full transition-colors relative cursor-pointer p-0.5 ${
                      hapticEnabled ? "bg-[#E8590C]" : "bg-[#E5E5EA]"
                    }`}
                  >
                    <div
                ...
                <div className="p-3.5 rounded-[22px] bg-[#F2F2F7] border border-[#E5E5EA] space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`w-11 h-6 rounded-full transition-colors relative cursor-pointer p-0.5 ${
                        notificationsEnabled ? "bg-[#E8590C]" : "bg-[#E5E5EA]"
                      }`}
                    >
                      <div
                        className={`w-5 h-5 rounded-full bg-white shadow-md transform transition-transform ${
                  ...
                  <button
                    onClick={() => {
                      triggerHaptic();
                      triggerTestNotification("Rifacimento bagno");
                    }}
                    className="w-full py-2 px-3 rounded-xl bg-white border border-[#E5E5EA] hover:border-[#E8590C] text-xs font-bold text-[#E8590C] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs active:scale-[0.98]"
                  >
                      ...
                      .map((rem) => (
                        ...
                        >
                          <div className="flex items-center gap-2.5 min-w-0">
                            <div className="w-8 h-8 rounded-xl bg-[#E8590C]/10 flex items-center justify-center shrink-0">
                              <Wrench className="w-4 h-4 text-[#E8590C]" />
                            </div>
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-full hover:bg-[#F2F2F7] text-[#8E8E93] hover:text-[#E8590C] transition-colors cursor-pointer shrink-0"
