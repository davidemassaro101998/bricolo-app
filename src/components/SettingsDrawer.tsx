      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm h-full bg-[#17111A] backdrop-blur-2xl border-l border-[#2B2130] pt-[max(16px,env(safe-area-inset-top,0px))] pb-[max(20px,env(safe-area-inset-bottom,0px))] px-5 shadow-2xl flex flex-col justify-between text-[#F5F1EA] font-sans overflow-hidden gpu-layer"
          >
            {/* Drawer Header */}
            <div className="flex items-center justify-between pb-3 border-b border-[#2B2130] mb-3">
              <div className="flex items-center gap-2">
                <div className="p-2 rounded-xl bg-[#FF8A1F] text-white shadow-xs">
              ...
              <button
                ...
                className="p-1.5 rounded-full hover:bg-[#1C1520] text-[#97908A] transition-colors cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
                ...
                <div className="p-3.5 rounded-[22px] bg-[#1C1520] border border-[#2B2130] flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`w-11 h-6 rounded-full transition-colors relative cursor-pointer p-0.5 ${
                      hapticEnabled ? "bg-[#FF8A1F]" : "bg-[#2B2130]"
                    }`}
                  >
                    <div
                ...
                <div className="p-3.5 rounded-[22px] bg-[#1C1520] border border-[#2B2130] space-y-2.5">
                  ...
                  {micPermission !== "granted" && (
                    <button
                      ...
                      className="w-full py-2 px-3 rounded-xl bg-[#17111A] border border-[#2B2130] hover:border-[#FF8A1F] text-xs font-bold text-[#FF8A1F] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs active:scale-[0.98]"
                    >
              ...
              <div className="space-y-2">
                ...
                <div className="p-3.5 rounded-[22px] bg-[#1C1520] border border-[#2B2130] space-y-3">
                  <button
                    ...
                    className="w-full py-2.5 px-3 rounded-xl bg-[#17111A] border border-[#2B2130] hover:border-[#FF8A1F] text-xs font-bold text-[#FF8A1F] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs active:scale-[0.98]"
                  >
